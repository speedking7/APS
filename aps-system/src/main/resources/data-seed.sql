...
-- t_bom
DELETE FROM t_bom;
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A012','11201A012-1',1,'aa','aa001','制造一部','单元A',1,30,1,30,0.01,'自制件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A012-1','21201A012',1,'bb','bb001','制造一部','单元A',1,31,1,31,0.02,'自制件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A012-1','11201A012-1-1',1,'bb','bb001','制造一部','单元A',1,31,1,31,0.02,'自制件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A012-1-1','31201A012',1,'cc','cc001','制造二部','单元B',1,33,1,33,0.04,'采购件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A012-1-1','31201A013',1,'cc','cc001','制造二部','单元B',1,33,1,33,0.04,'采购件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('21201A012','31201A014',1,'dd','dd001','制造二部','单元C',1,35,1,35,0.06,'采购件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('31201A013','41201A012',1,'ee','ee001','制造三部','单元D',1,36,1,36,0.07,'采购件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('41201A012',NULL,NULL,'ff','ff001','制造三部','单元D',1,37,1,37,0.08,'工艺节点','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('11201A022','21201A022',1,'aa','aa001','制造一部','单元A',1,38,1,38,0.09,'自制件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('21201A022','31201A022',1,'bb','bb002','制造二部','单元E',1,39,1,39,0.1,'采购件','20260331-1');
INSERT INTO t_bom (parent_code,child_code,usage_qty,process,equipment,manufacturing_department,manufacturing_unit,mold_cavity,cycle_time,staff_count,takt_time,scrap_rate,part_attribute,version) VALUES ('31201A022',NULL,NULL,'cc','cc002','制造三部','单元F',1,40,1,40,0.11,'工艺节点','20260331-1');
